...
namespace System.Data.Common
{
    internal static partial class ADP
    {
        ...
        {
            return InvalidOperation(Data.Res.GetString(Data.Res.ADP_QuotePrefixNotSet, method));
        }
        ...
        {
            return Argument(Data.Res.GetString(Data.Res.ADP_InvalidXMLBadVersion));
        }

        static internal Exception NotAPermissionElement()
        {
            return Argument(Data.Res.GetString(Data.Res.ADP_NotAPermissionElement));
        }

        static internal Exception PermissionTypeMismatch()
        {
            return Argument(Data.Res.GetString(Data.Res.ADP_PermissionTypeMismatch));
        }
        ...
        {
            return Argument(Data.Res.GetString(Data.Res.ConfigProviderNotFound));
        }
        static internal InvalidOperationException ConfigProviderInvalid()
        {
            return InvalidOperation(Data.Res.GetString(Data.Res.ConfigProviderInvalid));
        }

#if !MOBILE
        static internal ConfigurationException ConfigProviderNotInstalled()
        {
            return Configuration(Data.Res.GetString(Data.Res.ConfigProviderNotInstalled));
        }
        static internal ConfigurationException ConfigProviderMissing()
        {
            return Configuration(Data.Res.GetString(Data.Res.ConfigProviderMissing));
        }
        ...
        { // Res.Config_base_required_attribute_missing
            return Configuration(Data.Res.GetString(Data.Res.ConfigRequiredAttributeMissing, name), node);
        }
        ...
        { // Res.Config_base_required_attribute_empty
            return Configuration(Data.Res.GetString(Data.Res.ConfigRequiredAttributeEmpty, name), node);
        }
#endif
